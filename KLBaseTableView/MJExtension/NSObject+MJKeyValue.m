...
+ (id)objectWithKeyValuesOrKeyValuesArray:(id)keyValuesOrKeyValuesArray {
    if ([keyValuesOrKeyValuesArray isKindOfClass:[NSArray class]]) {
        return [self objectArrayWithKeyValuesArray:keyValuesOrKeyValuesArray];
    }else {
        return [self objectWithKeyValues:keyValuesOrKeyValuesArray];
    }
}
